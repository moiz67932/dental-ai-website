...
//         if (!result.id) {
//           throw new Error("Failed to retrieve clinic ID");
//         }
...
//     try {
//       if (wizardId) {
//         await updateClinic(wizardId, formData);
//       }
...
//       await updateClinic(wizardId, { status: "active" });

//       // Launch container
//       const launchResult = await launchContainer(wizardId);
...
//                 disabled={!!data.gcal_refresh_token}
//               />
...
//                     step2Form.setValue("send_whatsapp", checked)
//                   }
//                 />
...
//                   <Checkbox
//                     id="confirmed"
//                     checked={step3Form.watch("confirmed")}
//                     onCheckedChange={(checked) =>
//                       step3Form.setValue("confirmed", checked)
//                     }
//                   />
...
//                   </Label>
//                 </div>
//                 {step3Form.formState.errors.confirmed && (
//                   <p className="text-sm text-red-600">
//                     {step3Form.formState.errors.confirmed.message}
//                   </p>
//                 )}
...
//                     checked={step3Form.watch("recording_consent")}
//                     onCheckedChange={(checked) =>
//                       step3Form.setValue("recording_consent", checked)
//                     }
//                   />
...
//                   </Label>
//                 </div>
//                 {step3Form.formState.errors.recording_consent && (
//                   <p className="text-sm text-red-600">
//                     {step3Form.formState.errors.recording_consent.message}
//                   </p>
//                 )}
//               </div>
